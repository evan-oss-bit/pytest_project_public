<template>
  <section>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px">
      <el-form :inline="true" :model="filters">
        <el-col :span="20" justify="">
          ...
          <el-form-item>
            <el-input v-model="filters.cfg_name" placeholder="版本号" clearable @change="get_config_info">
          ...
          <div>
            <el-form-item>
              <el-button @click="handleAddEvent" type="primary"
                style="float: right; text-align: right; margin-left: 10px">新建脚本项目版本信息</el-button>
            </el-form-item>
          </div>
        </el-col>
      </el-form>
    ...
    <el-dialog title="新建或编辑项目版本信息" :close-on-click-modal="false" :visible.sync="detailFormVisible">
          ...
          <el-row>
            <el-col :span="9">
              <el-form-item label="版本号" required>
                <el-input ref="inputName" v-model="addForm.config_name" auto-complete="off" placeholder="版本号"
...
export default {
  data() {
    return {
      ...
      lstForm: [
        { prop: "id", label: "版本id", width: 100 },
        { prop: "version", label: "版本号", width: 130 },
  ...
  methods: {
    ...
    async AIOOIA() {
      ...
      if (this.continue_flag) {
        ...
        await add_version(para).then((res) => {
          this.listLoading = false;
